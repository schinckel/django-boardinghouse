    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('users', models.ManyToManyField(to=settings.AUTH_USER_MODEL, null=True, blank=True, help_text='Which users may access data from this schema.', related_name=b'schemata',)),
            ],
            options={
