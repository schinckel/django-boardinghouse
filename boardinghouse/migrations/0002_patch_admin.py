        ...
        migrations.CreateModel(
            ...
            fields=[
                ('schema', models.CharField(
                    primary_key=True, serialize=False, max_length=36,
                    validators=[django.core.validators.RegexValidator(
                        regex=r'^[a-z][a-z0-9_]*$',
                        message='May only contain lowercase letters, digits and underscores. '
                                'Must start with a letter.')],
                    help_text='The internal name of the schema.<br>'
                              'May only contain lowercase letters, digits and underscores. '
                              'Must start with a letter.<br>May not be changed after creation.', unique=True)),
                ...
                ('users', models.ManyToManyField(
                    help_text='Which users may access data from this schema.',
                    related_name='schemata', to=settings.AUTH_USER_MODEL, blank=True)),
            ],
            options={
