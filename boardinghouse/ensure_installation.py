...
if 'django.contrib.sessions.middleware.SessionMiddleware' not in settings.MIDDLEWARE_CLASSES:
    raise ImproperlyConfigured("You must have 'django.contrib.sessions.middleware.SessionMiddleware' in your MIDDLEWARE_CLASSES")
